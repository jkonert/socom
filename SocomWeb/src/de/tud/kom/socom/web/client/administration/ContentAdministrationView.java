...
public class ContentAdministrationView extends Composite implements AdministrationViewInterface<Object> {
	...
	interface AdministrationViewUiBinder extends UiBinder<Widget, ContentAdministrationView> {
	}

	public ContentAdministrationView(AdministrationPresenter presenter) {
	...
	public ContentAdministrationView(String firstName) {
		initWidget(uiBinder.createAndBindUi(this));
	}
