...
public class InfluenceAdministrationView extends Composite implements AdministrationViewInterface<Object> {
	...
	interface AdministrationViewUiBinder extends UiBinder<Widget, InfluenceAdministrationView> {
	}

	public InfluenceAdministrationView(AdministrationPresenter presenter) {
	...
	public InfluenceAdministrationView(String firstName) {
		initWidget(uiBinder.createAndBindUi(this));
	}
